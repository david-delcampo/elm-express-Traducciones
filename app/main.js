...
var _user$project$Main$pageHeader = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Traducciones')
				])),
			A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('cabecera'),
									_elm_lang$html$Html_Attributes$value('Texto')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('cabecera'),
									_elm_lang$html$Html_Attributes$value('Italiano')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('cabecera'),
									_elm_lang$html$Html_Attributes$value('Ingles')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]))
...
var _user$project$Main$cambiarTraduccion = F2(
	function ($new, old) {
		var _p0 = _elm_lang$core$Native_Utils.eq($new.id, old.id);
		if (_p0 === true) {
			return $new;
		} else {
			return old;
...
var _user$project$Main$baseUrl = 'http://127.0.0.1:3000/db/';
var _user$project$Main$traduccionEncoder = function (traduccion) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'texto',
				_1: _elm_lang$core$Json_Encode$string(traduccion.texto)
			},
				{
				ctor: '_Tuple2',
				_0: 'italiano',
				_1: _elm_lang$core$Json_Encode$string(traduccion.italiano)
			},
				{
				ctor: '_Tuple2',
				_0: 'ingles',
				_1: _elm_lang$core$Json_Encode$string(traduccion.ingles)
			},
				{
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$int(traduccion.id)
			}
			]));
};
var _user$project$Main$traduccionesEncoder = function (traducciones) {
	var listaDeObjectsJsE = A2(_elm_lang$core$List$map, _user$project$Main$traduccionEncoder, traducciones);
	var objectJsE = _elm_lang$core$Json_Encode$list(listaDeObjectsJsE);
	return A2(_elm_lang$core$Json_Encode$encode, 0, objectJsE);
};
var _user$project$Main$modeloInicial = {
	traducciones: _elm_lang$core$Native_List.fromArray(
		[])
};
var _user$project$Main$Traduccion = F4(
	function (a, b, c, d) {
		return {texto: a, italiano: b, ingles: c, id: d};
	});
var _user$project$Main$traduccionDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Main$Traduccion,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'texto', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'italiano', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ingles', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int));
var _user$project$Main$traduccionesDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$traduccionDecoder);
var _user$project$Main$Model = function (a) {
	return {traducciones: a};
};
var _user$project$Main$Cancelar = {ctor: 'Cancelar'};
var _user$project$Main$Aceptar = function (a) {
	return {ctor: 'Aceptar', _0: a};
};
var _user$project$Main$botones = function (traduccion) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('add small'),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$Aceptar(traduccion))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('add small'),
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Cancelar)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('✘')
...
var _user$project$Main$UpdateTraduccionIngles = F2(
	function (a, b) {
		return {ctor: 'UpdateTraduccionIngles', _0: a, _1: b};
	});
var _user$project$Main$UpdateTraduccionItaliano = F2(
	function (a, b) {
		return {ctor: 'UpdateTraduccionItaliano', _0: a, _1: b};
	});
var _user$project$Main$testo = function (traduccion) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Texto'),
						_elm_lang$html$Html_Attributes$value(traduccion.texto)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Italiano'),
						_elm_lang$html$Html_Attributes$value(traduccion.italiano),
						_elm_lang$html$Html_Events$onInput(
						_user$project$Main$UpdateTraduccionItaliano(traduccion))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Ingles'),
						_elm_lang$html$Html_Attributes$value(traduccion.ingles),
						_elm_lang$html$Html_Events$onInput(
						_user$project$Main$UpdateTraduccionIngles(traduccion))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Main$botones(traduccion)
			]));
};
var _user$project$Main$testos = function (traducciones) {
	var registros = A2(_elm_lang$core$List$map, _user$project$Main$testo, traducciones);
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Main$testos(model.traducciones)
			]));
};
var _user$project$Main$SetTraducciones = function (a) {
	return {ctor: 'SetTraducciones', _0: a};
};
var _user$project$Main$findAll = A2(
	_NoRedInk$elm_task_extra$Task_Extra$performFailproof,
	_user$project$Main$SetTraducciones,
	_elm_lang$core$Task$toMaybe(
		A2(_evancz$elm_http$Http$get, _user$project$Main$traduccionesDecoder, _user$project$Main$baseUrl)));
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$modeloInicial, _1: _user$project$Main$findAll};
var _user$project$Main$actualizarTraducciones = function (traducciones) {
	var body = _evancz$elm_http$Http$string(
		_user$project$Main$traduccionesEncoder(traducciones));
	return A2(
		_NoRedInk$elm_task_extra$Task_Extra$performFailproof,
		_user$project$Main$SetTraducciones,
		_elm_lang$core$Task$toMaybe(
			A2(
				_evancz$elm_http$Http$fromJson,
				_user$project$Main$traduccionesDecoder,
				A2(
					...
					_evancz$elm_http$Http$defaultSettings,
					{
						...
						url: _user$project$Main$baseUrl,
						body: body
					}))));
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'UpdateTraduccionItaliano':
				var newTraduccion = _elm_lang$core$Native_Utils.update(
					_p1._0,
					{italiano: _p1._1});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							traducciones: A2(
								_elm_lang$core$List$map,
								_user$project$Main$cambiarTraduccion(newTraduccion),
								model.traducciones)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateTraduccionIngles':
				var newTraduccion = _elm_lang$core$Native_Utils.update(
					_p1._0,
					{ingles: _p1._1});
				return {
			...
			case 'Aceptar':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$actualizarTraducciones(model.traducciones)
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
